  ...
  return (
    <section id="contact" className="py-24 md:py-48 bg-[#0a0a0a]">
      <div className="container mx-auto px-6 md:px-12 text-center">
        <span className="text-xs font-bold uppercase tracking-widest text-white/40 mb-8 block reveal">
          05 // Get in touch
        </span>
        <h2 className="text-5xl md:text-9xl font-outfit font-black tracking-tighter mb-16 uppercase hover:text-white/20 transition-all cursor-pointer reveal">
          Let's Build <br /> Something New.
        </h2>
        
        <div className="max-w-2xl mx-auto mt-24 reveal">
        ...
        <div className="mt-40 flex flex-wrap justify-center gap-12 text-xs font-bold uppercase tracking-widest text-white/40 reveal">
